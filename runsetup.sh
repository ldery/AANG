...
do
	echo $k
	base='nconfigsamples='$nconfigsamples'.devwd='$devWd'.basewd='$basewd'.prim-aux-lr='$soptlr'.auxiliaries-lr='$auxlr'.iterbsz='$iterbsz'.pergpubsz='$pergpubsz'.seed='$k'.gradAccumSteps='$gradAccumSteps'.spconfig='$spconfig'.warmupfrac='$wfrac'.devlr='$devlr'.metastepevery'$mstep'.cfwd='$cfwd'.devftiters='$devftiters'.temp'$temp'.'$ext
	echo $base
